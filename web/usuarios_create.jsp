...
<html>
    ...
    <body class="departamentos departamentos_create">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <form action="srvUsuarioController" class="form" id="usuarios_create" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="apellido_usuario" name="apellido_usuario" type="text" required/>
                        </div>
                        <div class="form-group">
                            <label for="username_usuario">Nombre de usuario:</label>
                            <input class="form-control" id="username_usuario" name="username_usuario" type="text" required/>
                        </div>
                        <div class="form-group">
